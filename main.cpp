...
glm::mat4 computeLightSpaceTrMatrix() {
	...
	glm::mat4 lightRot = glm::rotate(glm::mat4(1.0f),
		...
		glm::vec3(0.0f, 1.0f, 0.0f));
	glm::vec3 lightDirWorld = glm::mat3(lightRot) * lightDir;

	glm::mat4 lightView = glm::lookAt(lightDirWorld,
		glm::vec3(0.0f),
		glm::vec3(0.0f, 1.0f, 0.0f));

	const GLfloat near_plane = 0.1f, far_plane = 6.0f;
	glm::mat4 lightProjection = glm::ortho(-1.0f, 1.0f,
		-1.0f, 1.0f,
...
void renderScene() {
	...
	glUniformMatrix4fv(
		glGetUniformLocation(lightShader.shaderProgram, "view"),
		1,
		GL_FALSE,
		glm::value_ptr(view)
	);
	...
	glUniformMatrix4fv(
		glGetUniformLocation(lightShader.shaderProgram, "model"),
		1,
		GL_FALSE,
		glm::value_ptr(model)
	);
